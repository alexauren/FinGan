...
from keras.layers import Add, Multiply, BatchNormalization, UpSampling1D, Convolution1D, LeakyReLU
...
def generator_model_cnn():
  ...
  model_1 = Convolution1D(64,35,padding='same')(model_1)
  model_1 = BatchNormalization()(model_1)
  model_1 = LeakyReLU()(model_1)
  model_1 = UpSampling1D(2) (model_1)
  model_1 = Convolution1D(64,25,padding='same')(model_1)
  model_1 = BatchNormalization()(model_1)
  model_1 = LeakyReLU()(model_1)
  model_1 = UpSampling1D(2) (model_1)
  model_1 = Convolution1D(64,15,padding='same')(model_1)
  model_1 = BatchNormalization()(model_1)
  model_1 = LeakyReLU()(model_1)
  model_1 = UpSampling1D(2) (model_1)
  model_1 = Convolution1D(64,15,padding='same')(model_1)
  ...
  model_1 = UpSampling1D(2) (model_1)
  model_1 = Convolution1D(64,15,padding='same')(model_1)
  model_1_1 = Convolution1D(64,7,padding='same')(model_1)
  model_1_1_1 = Convolution1D(64,4,padding='same')(model_1)
  model_1 = Add()([model_1,model_1_1,model_1_1_1])
  model_1 = BatchNormalization()(model_1)
  model_1 = LeakyReLU()(model_1)
  model_1 = Convolution1D(1,1,padding='same')(model_1)
...
def discriminator_model():
  model = Sequential()
  model.add(Convolution1D(64,10,padding='same',input_shape=(8192,1)))
  model.add(LeakyReLU(0.2))
  model.add(Convolution1D(128,10,padding='same'))
  model.add(LeakyReLU(0.2))
  model.add(Convolution1D(128,10,padding='same'))
  model.add(LeakyReLU(0.2))
  model.add(Flatten())
